...
// checks if the CreatorDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatorDto{}

// CreatorDto struct for CreatorDto
type CreatorDto struct {
	...
	Transactions []CreatorTransactionDto `json:"transactions"`
	Shares []CreatorShareDto `json:"shares"`
}

type _CreatorDto CreatorDto
...
func (o CreatorDto) MarshalJSON() ([]byte, error) {
...
func (o CreatorDto) ToMap() (map[string]interface{}, error) {
...
func (o *CreatorDto) UnmarshalJSON(data []byte) (err error) {
	...
	varCreatorDto := _CreatorDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreatorDto)

	if err != nil {
		return err
	}

	*o = CreatorDto(varCreatorDto)

	return err
}

type NullableCreatorDto struct {
	value *CreatorDto
	isSet bool
}

func (v NullableCreatorDto) Get() *CreatorDto {
	return v.value
}

func (v *NullableCreatorDto) Set(val *CreatorDto) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatorDto) IsSet() bool {
	return v.isSet
}

func (v *NullableCreatorDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreatorDto(val *CreatorDto) *NullableCreatorDto {
	return &NullableCreatorDto{value: val, isSet: true}
}

func (v NullableCreatorDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreatorDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
